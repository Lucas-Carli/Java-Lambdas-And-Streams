...
public class StrategyLambdas {
    ...
    public static void main(String[] args) {
        ...
        var product2 = Product.builder().id(2L).name("Bear").price(150.0).userType("PLUS").build();
        var product3 = Product.builder().id(3L).name("Bear").price(150.0).userType("PRIME").build();
